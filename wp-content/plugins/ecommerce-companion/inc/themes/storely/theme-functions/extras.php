 ...
 function storely_get_slider5_default() {
	return apply_filters(
		'storely_get_slider5_default', json_encode(
				 array(
				array(
					'image_url'       => ECOMMERCE_COMP_PLUGIN_URL . 'inc/themes/shopwire/assets/images/slider/slider-1.jpg',
					'image_url2'       => ECOMMERCE_COMP_PLUGIN_URL . 'inc/themes/shopwire/assets/images/slider/slide-1.png',
				...
				array(
					'image_url'       => ECOMMERCE_COMP_PLUGIN_URL . 'inc/themes/shopwire/assets/images/slider/slider-2.jpg',
					'image_url2'       => ECOMMERCE_COMP_PLUGIN_URL . 'inc/themes/shopwire/assets/images/slider/slide-2.png',
					'title'           => esc_html__( 'New Season Dresses', 'storely-pro' ),
					'subtitle'         => esc_html__( 'UP TO', 'storely-pro' ),
					'subtitle2'         => esc_html__( '70% OFF', 'storely-pro' ),
					'subtitle3'         => esc_html__( 'Starting At', 'storely-pro' ),
				...
				array(
					'image_url'       => ECOMMERCE_COMP_PLUGIN_URL . 'inc/themes/shopwire/assets/images/slider/slider-3.jpg',
					'image_url2'       => ECOMMERCE_COMP_PLUGIN_URL . 'inc/themes/shopwire/assets/images/slider/slide-3.png',
					'title'           => esc_html__( 'New Season Dresses', 'storely-pro' ),
					'subtitle'         => esc_html__( 'UP TO', 'storely-pro' ),
					'subtitle2'         => esc_html__( '70% OFF', 'storely-pro' ),
					'subtitle3'         => esc_html__( 'Starting At', 'storely-pro' ),
